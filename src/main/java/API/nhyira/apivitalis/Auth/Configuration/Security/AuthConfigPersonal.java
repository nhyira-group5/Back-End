...
public class AuthConfigPersonal {
    ...
    @Autowired
    private AuthPersonalService authService;
    ...
    @Bean
    public AuthPersonalFilter jwtAuthenticationFilterBean() {
        return new AuthPersonalFilter(authService, jwtAuthenticationUntilBean());
    }
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(new AuthPersonalProvider(authService, passwordEncoder()));
