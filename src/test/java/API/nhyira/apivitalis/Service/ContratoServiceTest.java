...
class ContratoServiceTest {
    ...
    void cenarioSaveCorreto(){
        ...
        Usuario usuario = new Usuario(1, "marCOSSilV4","44581975840", "Marcos Silva Oliveira Pinto Santos", dataNascUsuario, "M", "marcos@example.com", "$2a$10$Ix.qCm5U71fFzjkd2/z3T.gKtgr9NzUzpqVOqAXU8uAcvv3ftooWS", Usuario.TipoUsuario.USUARIO, 0, null, null, null);

        Usuario personal = new Usuario(2, "w1llSalad","23456789012", "Will Dantas", dataNascPersoanl, "M", "will@example.com", "$2a$10$Ix.qCm5U71fFzjkd2/z3T.gKtgr9NzUzpqVOqAXU8uAcvv3ftooWS", Usuario.TipoUsuario.PERSONAL, 0, null, null, null);
